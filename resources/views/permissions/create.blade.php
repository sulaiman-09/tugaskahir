        ...
        <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
            ...
            <div class="card-body bg-light-subtle p-4">
                <form action="{{ route('permissions.store') }}" method="POST">
                    ...
                    {{-- Data Permission --}}
                    <div class="mb-4">
                        <h6 class="fw-semibold text-dark border-start border-3 ps-2 mb-3">Permission Information</h6>
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label fw-semibold small text-dark">Permission Name <span
