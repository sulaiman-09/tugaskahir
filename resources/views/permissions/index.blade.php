    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        ...
        <div class="dropdown position-relative" style="z-index: 1055;">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-2 show-on-top"
                ...
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input me-2 column-toggle" data-column="3" checked> Assigned Roles
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input me-2 column-toggle" data-column="4" checked> Created At
                    </label>
                </li>
                <li>
                    <label class="dropdown-item">
                        <input type="checkbox" class="form-check-input me-2 column-toggle" data-column="5" checked> Action
                    </label>
                </li>
            </ul>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="mt-3 text-end">
                <small class="text-muted">Showing {{ count($permissions) }} of {{ count($permissions) }} Results</small>
            </div>
        </div>
    </div>
</div>
