...
<div class="container mt-4">
    ...
    <div class="card mb-4 p-3 shadow-sm border-0 rounded-3">
        ...
        <div class="d-flex flex-wrap gap-2">
            ...
            @endforeach
            <button type="button" class="btn btn-outline-dark btn-sm" data-bs-toggle="collapse" data-bs-target="#customRange">
                Custom Range
            </button>
        </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu shadow border-0">
                <li><a class="dropdown-item" href="#"><i class="fa fa-file-excel text-success me-2"></i> Export XLSX</a></li>
                <li><a class="dropdown-item" href="#"><i class="fa fa-file-csv text-info me-2"></i> Export CSV</a></li>
            </ul>
        </div>
    ...
    <div class="table-responsive shadow-sm rounded-3">
        <table class="table table-striped table-hover align-middle text-center">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="13" class="text-muted text-center">Belum ada data customer</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
