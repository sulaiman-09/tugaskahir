            ...
            <div class="card-body bg-light-subtle p-4">
                <form method="POST" action="{{ route('customer.store') }}">
                    ...
                    <div class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Customer Name <span
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Telephone Number <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                <label class="form-label fw-semibold small">Full Address <span
                                        class="text-danger">*</span></label>
                                <textarea name="address" class="form-control rounded-3 shadow-sm border-0 bg-white" rows="2"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="referral_code"
                                    class="form-control rounded-3 shadow-sm border-0 bg-white" placeholder="Opsional">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label fw-semibold small">Province <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="city" name="city"
                                    class="form-select rounded-3 shadow-sm border-0 bg-white" disabled>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="latitude"
                                    class="form-control rounded-3 shadow-sm border-0 bg-white" placeholder="-7.123456">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Longitude</label>
                                <input type="text" name="longitude"
                                    class="form-control rounded-3 shadow-sm border-0 bg-white" placeholder="110.123456">
                            </div>
                        </div>
                    </div>
