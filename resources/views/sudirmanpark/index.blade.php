    ...
    <div class="container py-4">
        ...
        @push('styles')
            <style>
                ...
                /* Toolbar button styles (copied from Customer view for consistency) */
                .toolbar-btn {
                    display: inline-flex;
                    align-items: center;
                    gap: 0.5rem;
                ...
                /* Ensure primary buttons keep readable white text on hover */
                .toolbar-btn-primary:hover {
                    color: #ffffff !important;
                ...
                /* Keep toolbar buttons on one horizontal line and allow scrolling */
                .toolbar-scroll {
                    overflow-x: auto;
                    -webkit-overflow-scrolling: touch;
                    white-space: nowrap;
