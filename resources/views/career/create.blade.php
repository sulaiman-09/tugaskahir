            ...
            <div class="card-body bg-light-subtle p-4">
                <form action="{{ route('career.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="education_level" class="form-select rounded-3 shadow-sm border-0 bg-white">
                                    @foreach (['SMA/SMK', 'Diploma', 'S1', 'S2', 'S3'] as $edu)
                                        <option value="{{ $edu }}"
                                            {{ old('education_level') === $edu ? 'selected' : '' }}>{{ $edu }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="description" rows="2" class="form-control rounded-3 shadow-sm border-0 bg-white"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="job_description" rows="4" class="form-control rounded-3 shadow-sm border-0 bg-white"
                    ...
                    <div class="d-flex justify-content-between align-items-center border-top pt-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4 rounded-3 fw-semibold shadow-sm">Create
                            Career</button>
                    </div>
                </form>
            </div>
