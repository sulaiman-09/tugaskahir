...
<form action="{{ route('career.update', $career->id) }}" method="POST" enctype="multipart/form-data"
    class="career-edit-form">
    @csrf
    @method('PUT')

    {{-- Job Information --}}
    <div class="mb-4">
        <h6 class="fw-bold text-dark border-start border-3 ps-2 mb-3">Job Information</h6>
        <div class="row g-3">
            <div class="col-md-6">
    ...
    <div class="mb-4">
        <h6 class="fw-bold text-dark border-start border-3 ps-2 mb-3">Location & Description</h6>
        <div class="row g-3">
            <div class="col-md-6">
    ...
    {{-- Job Description --}}
    <div class="mb-4">
        <h6 class="fw-bold text-dark border-start border-3 ps-2 mb-3">Job Description</h6>
    ...
    {{-- Job Requirements --}}
    <div class="mb-4">
        <h6 class="fw-bold text-dark border-start border-3 ps-2 mb-3">Job Requirements</h6>
            ...
            @forelse ($requirements as $req)
                <div class="d-flex gap-2 requirement-item">
                    <input type="text" name="job_requirements[]"
                        class="form-control rounded-3 shadow-sm border-0 bg-white" value="{{ $req }}">
    ...
    {{-- Image & Status --}}
    <div class="mb-4">
        <h6 class="fw-bold text-dark border-start border-3 ps-2 mb-3">Cover & Status</h6>
