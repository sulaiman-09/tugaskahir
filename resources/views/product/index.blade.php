...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Tombol Aksi -->
        <div class="mb-3">
            <a href="{{ route('product.create') }}" class="btn btn-primary">+ Tambah Product Baru</a>
        </div>
                    ...
                    <table class="table table-bordered align-middle text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Izzi Life 30</td>
                                <td>30 Mbps</td>
                                <td><img src="{{ asset('images/website1.jpg') }}" alt="Website Image" class="img-thumbnail"
                                        width="150"></td>
                                <td><img src="{{ asset('images/app1.jpg') }}" alt="App Image" class="img-thumbnail"
                                        width="150"></td>
                                <td>Broadband Internet</td>
                                <td>Rp 166.500</td>
                            ...
                            <tr>
                                ...
                                <td>10 Mbps</td>
                                <td><img src="{{ asset('images/website2.jpg') }}" alt="Website Image" class="img-thumbnail"
                                        width="150"></td>
                                <td><img src="{{ asset('images/app2.jpg') }}" alt="App Image" class="img-thumbnail"
                                        width="150"></td>
                                <td>Business Solutions</td>
                                <td>Rp 1.700.000</td>
                            ...
                            <tr>
                                ...
                                <td>Izzi Life 100</td>
                                <td>100 Mbps</td>
                                <td><img src="{{ asset('images/website3.jpg') }}" alt="Website Image" class="img-thumbnail"
                                        width="150"></td>
                                <td><img src="{{ asset('images/app3.jpg') }}" alt="App Image" class="img-thumbnail"
                                        width="150"></td>
                                <td>Broadband Internet</td>
                                <td>Rp 388.500</td>
